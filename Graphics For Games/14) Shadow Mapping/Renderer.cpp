...
Renderer::Renderer(Window & parent) : OGLRenderer(parent) {
	...
	floor -> SetTexture(SOIL_load_OGL_texture(TEXTUREDIR"volc.jpg",SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS));
	floor -> SetBumpMap(SOIL_load_OGL_texture(TEXTUREDIR"volcm.png",SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS));
...
void Renderer::DrawShadowScene() {
	...
	//lol haha this is really weird to type on!
