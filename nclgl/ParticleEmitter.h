...
public:
	...
	*/
	void UpdateExplo(float msec);
	void UpdateSnow(float msec);
	void UpdateVolcano(float msec);
...
protected:
	...
	*/
	Particle* GetFreeParticleExplo();
	Particle* GetFreeParticleSnow();
	Particle* GetFreeParticleVolcano();
	/*
