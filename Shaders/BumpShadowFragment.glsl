...
float rFactor1 = max (0.0 , dot ( halfDir1 , normal )); // Different !
...
colour1 += ( lightColour1 . rgb * sFactor ) * 0.33;
colour += ( lightColour . rgb * sFactor ) * 0.33;

gl_FragColor = vec4 ( colour * atten * lambert , diffuse . a )+vec4(colour1 * atten1 * lambert1 , diffuse . a);
